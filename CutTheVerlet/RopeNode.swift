...
class RopeNode: SKNode {
   /*
    ...
    custom class that inherits from SKNode.
    It doesn’t have any visual appearance of its own 
    acts as container for a collection of SKSpriteNodes 
    representing the rope segments.
